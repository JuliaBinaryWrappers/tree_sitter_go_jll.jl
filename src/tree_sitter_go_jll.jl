...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import tree_sitter_go_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("beecb120-e197-59fa-b79c-0316d51c9920"))
platforms = [Pkg.Artifacts.unpack_platform(e, "tree_sitter_go", artifacts_toml) for e in artifacts["tree_sitter_go"]]
...
if best_platform === nothing
    @debug("Unable to load tree_sitter_go; unsupported platform $(triplet(platform_key_abi()))")
else
